  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div class="relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            we're here to make meaningful connections happen.
          </p>
      ...
      <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-20 left-20 w-24 h-24 bg-indigo-200 dark:bg-indigo-800 rounded-full opacity-20 animate-pulse delay-2000"></div>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Our platform is designed to create meaningful mentorship relationships 
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p class="text-gray-600 dark:text-gray-300">
              Connect with industry professionals who have walked the path you want to take.
            </p>
          </div>
          ...
          <div class="text-center p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-xl flex items-center justify-center mx-auto mb-4">
              <Icon name="heroicons:chat-bubble-left-right" class="w-6 h-6 text-green-600 dark:text-green-400" />
            </div>
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              Seamless Communication
            </h3>
            <p class="text-gray-600 dark:text-gray-300">
              Stay connected with built-in messaging and video call integration.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="py-16">
      <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-8">
          Join thousands of professionals who are already growing their careers with iMentorsPro.
        </p>
        
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <UButton
            to="/auth/signup?role=mentee"
            size="lg"
            class="px-8 py-3 text-lg font-semibold"
          >
            Find a Mentor
