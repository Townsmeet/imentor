      ...
      <div class="grid md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400 text-sm">
            ...
            <li><NuxtLink to="/auth/register?role=mentor" class="hover:text-white transition">Become a Mentor/Coach</NuxtLink></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400 text-sm">
            ...
            <li><NuxtLink to="/cookies" class="hover:text-white transition">Cookie Policy</NuxtLink></li>
          </ul>
        </div>
      </div>
